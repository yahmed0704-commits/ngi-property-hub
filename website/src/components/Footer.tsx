    ...
    <footer style={{ background: '#080f18', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="container-site py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          {/* Navigation — 2-column grid on mobile to save space */}
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
              <li className="flex items-start gap-2">
                <span style={{ color: '#C9912A' }} className="mt-0.5 flex-shrink-0">📍</span>
            ...
            <div className="mt-5">
              <Link to="/contact" className="btn-gold text-sm py-2.5 px-5 w-full sm:w-auto justify-center">
                Contact Us
              </Link>
            </div>
          </div>
        ...
        >
          <p className="text-xs text-center sm:text-left" style={{ color: 'rgba(255,255,255,0.3)' }}>
            © {new Date().getFullYear()} Nexus Growth Inc. All rights reserved.
          </p>
          <p className="text-xs text-center sm:text-right" style={{ color: 'rgba(255,255,255,0.2)' }}>
            nexusgrowthinc.com · New York Real Estate
          </p>
        </div>
      </div>
    </footer>
