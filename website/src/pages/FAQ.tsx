    ...
    <div>
      <section className="page-hero">
        <div className="container-site text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4">Frequently Asked Questions</h1>
      ...
      <section className="py-12 md:py-20" style={{ background: '#080f18' }}>
        <div className="container-site max-w-3xl mx-auto">
          ...
          <div className="mt-10 text-center rounded-2xl p-6 md:p-8" style={{ border: '1px solid rgba(201,145,42,0.15)', background: 'rgba(201,145,42,0.05)' }}>
            <h3 className="font-bold text-lg md:text-xl mb-3 text-white">Still Have Questions?</h3>
